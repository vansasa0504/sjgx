...
import type { Bill, BillingRule, BillingStats } from './types'
...
export const getBill = async (billNo: string) => unwrap<Bill>(await api.get(`/billing/bills/${billNo}`))
...
export const getBillingStats = async (params: Record<string, unknown> = {}) => unwrap<BillingStats>(await api.get('/billing/stats', { params }))
