...
ALTER TABLE t_api_credential ADD secret_cipher VARCHAR(1024);
ALTER TABLE t_api_credential ADD secret_hash VARCHAR(128);
ALTER TABLE t_api_credential ADD status VARCHAR(32) DEFAULT 'ACTIVE';
ALTER TABLE t_api_credential ADD rotated_from BIGINT;
