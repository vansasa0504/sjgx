...
echo "Check application degraded behavior and consumer lag alarms."
...
echo "Expected: messages are retained or replayed; backlog alarm is raised and drains after recovery."
